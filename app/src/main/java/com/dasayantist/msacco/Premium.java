...
//        int x =  Integer.parseInt(penalty);
//        int y =  Integer.parseInt(interest);
//        String content = etLAmount.getText().toString();
//        etLAmount.setText(0);
//        int z = Integer.parseInt(content);
//        txt_principal1.setText(x-(y+z));

        if(extras != null) {
            loan_bal = extras.getString("loan_bal");
            loan_id = extras.getString("loan_id");
            penalty = extras.getString("penalty");
